    ...
    <footer className="bg-white border-t border-slate-200 text-slate-800 font-sans font-normal">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* WhatsApp Support / Corporate Office Column */}
          <div>
            ...
            <ul className="space-y-3.5 text-xs">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/923036088497?text=Hello%20Lahore%20Medical%20Lab.%20I%20want%20to%20inquire%20about%20diagnostic%20tests%20and%20home%20sample%20collection." target="_blank" referrerPolicy="no-referrer" className="hover:text-[#25D366] text-slate-800 font-mono transition font-semibold">
                  +92 303 6088497 (WhatsApp Only)
                </a>
              </li>
              <li className="flex items-center gap-2">
